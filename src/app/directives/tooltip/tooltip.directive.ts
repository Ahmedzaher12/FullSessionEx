...
export class TooltipDirective {
  ...
  onMouseMove($event: MouseEvent): void {
    if (this.componentRef !== null && this.position === TooltipPosition.DYNAMIC) {
      ...
      this.componentRef.instance.linkText = this.linkText;
      this.componentRef.instance.linkText = this.linkText;
      this.componentRef.instance.linkURL = this.linkURL;
      this.componentRef.instance.isCustome = this.isCustome;
    }
  }
